...
static inline vec2_t vec2_add(vec2_t p1, vec2_t p2) {
  return (vec2_t){.v0=p1.v0 + p2.v0, .v1 = p1.v1 + p2.v1};
}

static inline vec2_t vec2_subtract(vec2_t p1, vec2_t p2) {
  return (vec2_t){.v0=p1.v0 - p2.v0, .v1 = p1.v1 - p2.v1};
}

static inline float vec2_dot(vec2_t p1, vec2_t p2) {
  return (p1.v0 * p2.v0) + (p1.v1 * p2.v1);
}

static inline vec2_t vec2_scale(vec2_t p, float scalar) {
